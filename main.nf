...
process map_16s_native {
    ...
    publishDir "$params.outdir/sams_16s_native", mode:'copy'
...
process map_16s_ivt {
    ...
    publishDir "$params.outdir/sams_16s_ivt", mode:'copy'
...
process map_23s_native {
    ...
    publishDir "$params.outdir/sams_23s_native", mode:'copy'
...
process map_23s_ivt {
    ...
    publishDir "$params.outdir/sams_23s_ivt", mode:'copy'
